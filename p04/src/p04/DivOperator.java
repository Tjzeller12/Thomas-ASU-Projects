/**
 * Class DivOperator.  Represents the division operator which is a
...
/**
 * Represents the division operator which is a specific type of
 * binary operator.
 */
public class DivOperator extends BinaryOperator {
     ...
     * @param pRhsOperand right operand to division expression
     * @return a Double.
     */
    @Override
